  ...
  plugin.trial = function (display_element, trial) {
    ...
    function setupTrial() {
      ...
      if (trial.prompt !== null) {
        ...
        display_element.innerHTML += '<p></p>';
        display_element.innerHTML += '<img src="'+trial.stimulus_feedback +'" id="jspsych-image-keyboard-response-feedback-stimulus" class="jspsych-categorize-image-stimulus" style="margin-left: auto;margin-right: auto;height: 100;"">'
